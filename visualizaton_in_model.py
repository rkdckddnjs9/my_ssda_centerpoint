...
# path = "/home/changwon/data/ROS/husky_prediction_bag/pvrcnn_result_2/"
# scene = "000001"
...
# o3d.visualization.draw_geometries([pc_new] + [i for i in box_line_] + [coord])
...
path = "/home/changwon/detection_task/SSOD/kakao/my_ssda_2/vis_in_model/"
# path = "/home/changwon/detection_task/0711/3DIoUMatch-PVRCNN/3d_aug_vis/sever17/"
# path = "/home/changwon/detection_task/0711/3DIoUMatch-PVRCNN/3d_aug_vis/test/"  #pred

import os
pcd_1_path = "/home/changwon/detection_task/SSOD/kakao/my_ssda_2/vis_in_model/pc"
# pcd_1_path = "/home/changwon/detection_task/0711/3DIoUMatch-PVRCNN/3d_aug_vis/sever17/pc"
# pcd_1_path = "/home/changwon/detection_task/0711/3DIoUMatch-PVRCNN/3d_aug_vis/test/pc" #pred
pcd_list_1 = os.listdir(pcd_1_path)
# p_list_1 = [int(i.split(".")[0]) for i in pcd_list_1]
p_list_1 = [i for i in pcd_list_1]
p_list_1.sort()
...
for i in p_list_1:
    ...
    npy_name = "{}.npy".format(scene) 
    txt_name = "{}.txt".format(scene)
    #txt_name = "pred_{}.txt".format(scene) #pred

    pc = np.load(path+ "pc/" + npy_name)
    try :
        gt_box_ = txt_read(path + "box/" + txt_name)[0].split(",")
    except:
        continue
    gt_box = []
    for num in range(len(gt_box_)-1):
    ...
    for i in range(all_cls):
        ...
        # gt_box_1 = [gt_box[id-x + 4],gt_box[idx + 5],gt_box[idx + 6], gt_box[idx + 0],gt_box[idx + 1],gt_box[idx + 2], gt_box[idx + 3]]
        # gt_.append(gt_box_1)
        # box3d_from_label = box_center_to_corner(gt_box_1)
        ...
        pc_array = np.load(path+ "pc/" + npy_name)[:,1:4]
        pc_new = o3d.PointCloud()
        pc_new.points = o3d.Vector3dVector(pc_array)
        pc_new.colors = o3d.Vector3dVector(np.zeros_like(pc_array))
